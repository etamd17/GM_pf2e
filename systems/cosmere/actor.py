...
def _enrich(text, actor_name='') -> str:
    """Turn Foundry ``cosmere-rpg`` inline enrichers into readable prose so the
    tracker/stat block reads like English instead of raw markup:
